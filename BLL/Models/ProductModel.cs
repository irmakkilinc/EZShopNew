...
namespace BLL.Models
{
    public class ProductModel
    {
        ...
        // Way 1:
        //public int StockAmount => Record.StockAmount.HasValue ? 
        //  Record.StockAmount.Value : 0;
        ...
        public string ExpirationDate => Record.ExpirationDate.HasValue ? 
            Record.ExpirationDate.Value.ToString("MM/dd/yyyy") : string.Empty;
